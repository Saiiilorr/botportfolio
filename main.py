...
/skills - используй для добавления нового навыка 
/projects - используй для получения инфо о проекте 
/delete - используй для удаления проекта из списка
/update_projects - используй для обновления информации о твоём проекте (skills или status)
